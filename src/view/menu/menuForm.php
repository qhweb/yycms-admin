	...
	<form class="layui-form" action="">
		...
		<div class="layui-form-item">
	  	...
	  	<div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		    	<button type="button" class="layui-btn layui-btn-danger" yycms-event="dialog" data-width="800" data-height="700" data-href='{:url("icon")}/input/icon'>选择图标</button>
		    </div>
	  	</div>
		<div class="layui-form-item">
...
<script>layui.use('form', function(exports){layui.form.render();});</script>