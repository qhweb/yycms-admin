...
layui.config({
    ...
    Class.prototype.pullData = function(curr, loadIndex){
        ...
        if(options.url){ //Ajax请求
            ...
            $.ajax({
                ...
                ,error: function(e, m){
                    that.layMain.html('<div class="'+ NONE +'">treeGrid:数据接口请求异常</div>');
                    that.renderForm();
                    loadIndex && layer.close(loadIndex);
                }
            });
    ...
    Class.prototype.events = function(){
        var that = this
            ...
            ,resizing;
        //工具栏操作事件
        that.layTool.unbind('click').on('click', '*[lay-event]', function(e){
            var othis = $(this)
